export const ALL_OPCODES = [
  ...
  'L2D','F2I','F2L','F2D','D2I','D2L','D2F','I2B','I2C','I2S','LCMP','FCMPL','FCMPG','DCMPL','DCMPG','IFEQ',
...
export function normalizeOpcode(opcode) {
  return opcode.replace(/_.*/, '').replace(/\s+/g, '').toUpperCase();
}

export function getNormalizedOpcodeSet() {
  return new Set(ALL_OPCODES.map(normalizeOpcode));
}

export default {
  ALL_OPCODES,
  normalizeOpcode,
  getNormalizedOpcodeSet,
};
